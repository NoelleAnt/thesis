...
import { RESOURCE_STATUS, RESOURCE_TYPES } from './data.js';

/**
 * Decision-support priority score for LDRRMO dashboard.
 * Higher score = needs more immediate attention.
 *
 * Factors (per specification):
 * - Number of evacuees
 * - Reported critical shortages
 * - Availability of basic services (resource status)
